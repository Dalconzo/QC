...
def describe_manifest(manifest_path: Path) -> dict:
    ...
    return {
        ...
        "derived_deleted_at_local": playback["derived_deleted_at_local"],
        ...
        "derived_retain_until_local": str(retention.get("derived_retain_until_local") or ""),
        "derived_delete_eligible_at_local": str(retention.get("derived_delete_eligible_at_local") or ""),
