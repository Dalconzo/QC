...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--dsn-file", default="mysql_labsite.dsn", help="Path to DSN file with MySQL creds")
    ...
    p.add_argument("--aliases-file", default=os.path.join(os.getcwd(), "machine-aliases.json"), help="JSON mapping of H-machines to DB instrument names/codes")
    return p.parse_args()
