...
```powershell
powershell.exe -NoProfile -File "C:\QC\qc-hamilton-dailycopy.ps1"
```
...
4. Actions: start program  
   ...
   Add arguments: `-NoProfile -ExecutionPolicy Bypass -File "C:\QC\qc-hamilton-dailycopy.ps1" -MachineName "H8"`
...
```powershell
powershell.exe -NoProfile -File "C:\QC\qc-hamilton-backfill.ps1"
```
